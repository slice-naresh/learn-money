...
- **Tests guard this spec:** `test_journeys.js` (62), `test_buckets.js` (11), `test_features.js` (56), `ui_test.js` (24), `qa_break.js` (19 adversarial), `design_lint.js` (7 UI/UX-usability lints: no default-styled controls, accessible names, descriptions on choice-cards, WCAG AA contrast, tap targets, glossary coverage). Build: `python3 gen.py`.
