...
- **CHART-1 (usable charts)** Every chart is labeled, not just decorative: **Goal chart** has ₹ Y-axis gridlines + year X-axis + goal/final markers; **growth** and **inflation** charts carry a plain-language "Reading it" caption stating X = years, Y = ₹ value/worth, and what each curve means.
